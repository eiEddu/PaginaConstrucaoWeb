...
import { UsuarioAtividadesComponent } from './pages/usuarios/usuario-atividades/usuario-atividades.component';
...
export const routes: Routes = [
  ...
  { path: 'usuarios/:id/atividades', component: UsuarioAtividadesComponent },
